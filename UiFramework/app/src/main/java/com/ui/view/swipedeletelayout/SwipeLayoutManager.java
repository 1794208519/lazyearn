package com.ui.view.swipedeletelayout;
...
public class SwipeLayoutManager {
    ...
    private SwipedeleteLayout openLayout;
    public void setSwipeLayout(SwipedeleteLayout swipeLayout){
     ...
     * @return
     */
    public boolean isCanSwipe(SwipedeleteLayout currentLayout){
        if(openLayout==null){
            //说明当前木有打开的，那么可以滑动
            return true;
        }else {
