...
public class MyWeixinHaoYouAdapter extends RecyclerView.Adapter<MyWeixinHaoYouAdapter.MyViewHolder> {
    private List<String> weixinhaoList = new ArrayList<String>();
    private Context context;

    private OnItemClickListener mOnItemClickListener = null;

    public MyWeixinHaoYouAdapter(List<String> weixinhaoList, Context context) {
        this.weixinhaoList = weixinhaoList;
        this.context = context;
    }

    public MyWeixinHaoYouAdapter() {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        String headName = "";
        try {
            headName = java.net.URLEncoder.encode(weixinhaoList.get(position), "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        String url = Urlutils.myweixinheadUrl + "head_" + headName + ".jpg";
        Log.i("zw1014", url);
