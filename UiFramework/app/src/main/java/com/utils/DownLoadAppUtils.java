...
public class DownLoadAppUtils {
     ...
     * @param context
     */
    public void updateApp(final Context context, String versionName) {
        mDialog = new CustomerDialog(context, new Callback() {
            @Override
            public void positiveCallback() {
                DownLoadAppUtils loadAppUtil = new DownLoadAppUtils(path, context);
                loadAppUtil.startThread();
            }

            @Override
            public void negativeCallback() {
                ToastUtils.showShort(context, "可以手动设置更新");
            }
        });
        mDialog.setContent("发现新版本:" + versionName + "\n是否下载更新?");
