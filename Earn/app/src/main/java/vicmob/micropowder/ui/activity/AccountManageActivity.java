...
public class AccountManageActivity extends BaseActivity {
    ...
    private void initDate() {
        ...
        String attentionTitle[] = {
                getResources().getString(R.string.wechat_nearby),
                ...
                getResources().getString(R.string.wechat_send_message), getResources().getString(R.string.wechat_whitelist)};
        String attentionContent[] = {
                ...
                getResources().getString(R.string.wechat_send_message_content), getResources().getString(R.string.wechat_whitelist_content)};
